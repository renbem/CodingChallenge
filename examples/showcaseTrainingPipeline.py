...
if __name__ == '__main__':
    ...
    data_base = DataBase.DataBase(data_reader.get_samples(), batch_size=8, seed=None)
    data_base.build_training_database()
    ...
    while (count < 5):        
        ...
        images_array, targets_array = data_base.get_next_batch()
        
        # Variant B: Get random batch of length batch_size
        # images_array, targets_array = data_base.get_random_batch()
